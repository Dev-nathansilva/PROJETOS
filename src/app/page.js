...
const Projects = [
  ...
  },
  {
    ...
    description:
      "Landing Page da Lumere, empresa de assessoria em marketing digital. Estratégias modernas para impulsionar negócios. Feito com Wordpress, CSS e JS.",
  },
  {
    name: "CROCS",
  ...
  return (
    <div>
      ...
      {selectedProject && (
        <div
          onClick={closeModal}
          className="fixed inset-0 z-50 flex items-center justify-center bg-[#03001B]/50 px-4"
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="bg-[#ccc] rounded-xl max-w-md w-full px-6 py-14 sm:py-10 space-y-4 text-black relative"
          >
            <button
              onClick={closeModal}
            ...
            <h2 className="flex items-center gap-3 font-mono text-2xl font-bold text-gray-900">
              <FaCircleInfo />
